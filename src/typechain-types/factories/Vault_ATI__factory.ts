...
import type { Vault_ATI, Vault_ATIInterface } from "../Vault_ATI";
...
type Vault_ATIConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: Vault_ATIConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class Vault_ATI__factory extends ContractFactory {
  constructor(...args: Vault_ATIConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): Vault_ATI__factory {
    return super.connect(runner) as Vault_ATI__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): Vault_ATIInterface {
    return new Interface(_abi) as Vault_ATIInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Vault_ATI {
    return new Contract(address, _abi, runner) as unknown as Vault_ATI;
  }
}
