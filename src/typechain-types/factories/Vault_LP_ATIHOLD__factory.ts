...
import type {
  Vault_LP_ATIHOLD,
  Vault_LP_ATIHOLDInterface,
} from "../Vault_LP_ATIHOLD";
...
type Vault_LP_ATIHOLDConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: Vault_LP_ATIHOLDConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class Vault_LP_ATIHOLD__factory extends ContractFactory {
  constructor(...args: Vault_LP_ATIHOLDConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): Vault_LP_ATIHOLD__factory {
    return super.connect(runner) as Vault_LP_ATIHOLD__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): Vault_LP_ATIHOLDInterface {
    return new Interface(_abi) as Vault_LP_ATIHOLDInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): Vault_LP_ATIHOLD {
    return new Contract(address, _abi, runner) as unknown as Vault_LP_ATIHOLD;
  }
}
