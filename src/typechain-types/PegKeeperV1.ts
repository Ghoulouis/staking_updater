...
export interface PegKeeperV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "AGGREGATOR"
      | "I"
...
export interface PegKeeperV1 extends BaseContract {
  connect(runner?: ContractRunner | null): PegKeeperV1;
  waitForDeployment(): Promise<this>;

  interface: PegKeeperV1Interface;
