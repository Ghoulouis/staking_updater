...
export interface Univ3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "collect"
...
export interface Univ3 extends BaseContract {
  connect(runner?: ContractRunner | null): Univ3;
  waitForDeployment(): Promise<this>;

  interface: Univ3Interface;
